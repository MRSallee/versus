...
var metadata = {
    ...
    categories = {
        category1 : {
            ...
            thumbnail: 'http://assets2.ignimgs.com/2013/12/19/versusgames1280jpg-e974ab.jpg',
        ...
        category2 : {
            name: 'Exclusives',
            question: 'Who had the best <b>exclusives</b>?',
            thumbnail: 'http://assets1.ignimgs.com/2013/12/19/versushardware1280jpg-8860f6.jpg',
        ...
        category3 : {
            name: 'Overall',
            thumbnail: 'http://assets2.ignimgs.com/2013/12/19/versusoverall1280jpg-e974ad.jpg',
        ...
        category4 : {
            name: 'Thanks',
            question: 'Thanks for <b>watching</b>.',
